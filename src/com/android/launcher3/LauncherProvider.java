...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // This was the old L2-based KylinModLauncher's version. Do steps that come after version 12 
            ...
            if (version == 16) {
                Log.w(TAG, "Found pre-11 KylinModLauncher, preparing update");
            ...
            // after a possible 44.2-KylinModLauncher migration
